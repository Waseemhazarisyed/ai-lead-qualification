...
TEST_CASES_FILE = BASE_DIR / "holdout_cases.json"
RESULTS_FILE = BASE_DIR / "holdout_results.json"
...
for case in test_cases:
    ...
    # Run through the real LangGraph workflow
...
print(
    f"\nDetailed holdout results saved to: "
    f"{RESULTS_FILE}"
)